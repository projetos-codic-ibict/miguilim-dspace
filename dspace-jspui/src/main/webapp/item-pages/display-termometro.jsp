        ...
        <div class="panel-body">
            ...
            <div class="detalhamento-pontuacao">
                ...
                <table class="table panel-body">
                    ...
                    <tr>
                        <td class="oddRowOddCol" colspan="5">Escala de respostas:<br>Tradicional = 0 pontos<br>Ahead of
                            print = 1
                    ...
                    <tr>
                        <td class="oddRowOddCol" colspan="5">Escala de respostas:<br>A revista publica somente o nome de
                            avaliadores
                            ...
                            período = 2
                            pontos<br>A revista somente publica avaliadores que concordam com a publicação do seu nome =
                            1 ponto<br>A
                            revista não publica o nome dos avaliadores, mas disponibiliza a lista de pesquisadores
                            cadastrados como
                            possíveis avaliadores = 0 pontos<br>A revista não publica nem revela o nome dos avaliadores
                            = 0
                            pontos<br></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="oddRowEvenCol" colspan="5">Escala de respostas:<br>A revista publica, no expediente,
                            a listagem
                            dos avaliadores que realizaram avaliações = 2 pontos<br>A revista publica, no corpo do
                            documento
                            aprovado na avaliação por pares, o nome dos avaliadores responsáveis = 1 ponto<br>A revista
                            publica os
                            pareceres resultantes das avaliações realizadas com o nome dos avaliadores = 2 pontos<br>A
                            revista não
                            publica o nome dos avaliadores, mas disponibiliza a lista de pesquisadores cadastrados como
                            possíveis
                    ...
                    <tr>
                        <td class="oddRowOddCol" colspan="5">Escala de respostas:<br>A avaliação por pares é realizada,
                            ...
                            avaliação por pares
                            é realizada por pesquisadores da instituiçao que edita a revista e por pesquisadores que são
                            externos à
                    ...
                    <tr>
                        <td class="oddRowEvenCol" colspan="5">Escala de respostas:<br>A revista aceita a submissão de
                            preprints que
                    ...
                    <tr>
                        <td class="oddRowOddCol" colspan="5">Escala de respostas:<br>Amarela: permite o armazenamento e
                            acesso das
                            ...
                            ponto<br>Branca: apresenta restrições para o armazenamento e acesso das versões preprint e
                            pós-print dos
                            documentos em repositórios institucionais/digitais = 0 pontos<br>Verde: permite o
                            armazenamento e acesso
                            das versões preprint e pós-print dos documentos em repositórios institucionais/digitais = 2
                            pontos<br>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="oddRowEvenCol" colspan="5">Escala de respostas:<br>Imediatamente após a aceitação do
                            documento =
                    ...
                    <tr>
                        <td class="oddRowOddCol" colspan="5">Escala de respostas:<br>Acesso aberto imediato = 2
                            pontos<br>Acesso
                            aberto após período de embargo = 1 ponto<br>Acesso restrito = 0 pontos<br>Acesso híbrido = 1
                            ponto<br>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="oddRowEvenCol" colspan="5">Escala de respostas:<br>Permite distribuição, remixagem,
                            adaptação e
                            criação a partir da obra, mesmo para fins comerciais, desde que seja atribuído o crédito ao
                            autor da
                            obra original (CC BY) = 2 pontos<br>Permite distribuição, remixagem, adaptação e criação a
                            partir da
                            ...
                            redistribuição, comercial ou não comercial, desde que a obra não seja modificada e que seja
                            atribuído o
                            crédito ao autor (CC BY-ND) = 1 ponto<br>Permite remixagem, adaptação e criação a partir da
                            obra, desde
                            que seja atribuído o crédito ao autor e que a nova criação não seja usada para fins
                            comerciais (CC
                            BY-NC) = 1 ponto<br>Permite remixagem, adaptação e criação a partir da obra, para fins não
                            comerciais,
                            desde que seja atribuído o crédito ao autor da obra original e que as novas criações
                            utilizem a mesma
                            licença da obra original (CC BY-NC-SA) = 1 ponto<br>Permite redistribuição não comercial,
                            desde que seja
                            atribuído o crédito ao autor e que a obra não seja alterada de nenhuma forma (CC BY-NC-ND) =
                            0
                            pontos<br></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="oddRowOddCol" colspan="5">Escala de respostas:<br>A revista cobra taxa de submissão
                            de artigos =
                            0 pontos<br>A revista cobra taxa de processamento de artigos (APC) = 0 pontos<br>A revista
                            cobra taxa de
                            submissão e de processamento de artigos = 0 pontos<br>A revista não cobra nenhuma taxa de
                            publicação = 2
                            pontos<br></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="oddRowOddCol" colspan="5">Escala de respostas:<br>A revista exige que os autores
                            ...
                            revista publica
                            os dados que deram origem à pesquisa na própria revista = 0 pontos<br>A revista não exige
                            que os autores
    ...
    <div id="collapseH5" class="panel-collapse collapse"
        ...
        <div class="panel-body">
            ...
            <%=pontuacaoIndiceH5%>
                    ...
                    <p>O H5 é um índice do Google que busca quantificar o impacto de uma revista com base no número de
                        citações
                        obtidas pelos artigos da revista nos últimos 5 anos. Para compreender o cálculo do Índice H5 de
                        maneira
                        simples deve-se considerar o seguinte: se uma revista possui um H5 de 10 é porque nos últimos 5
                        anos ela
