    ...
    <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li class="<%= currentPage.endsWith("/historico-de-acoes") ? "active" : "" %>"><a href="<%= request.getContextPath() %>/static/pages/Historico_de_acoes_da_equipe_miguilim.pdf"><fmt:message key="jsp.layout.navbar.miguilim.actionhistory"/></a></li>
