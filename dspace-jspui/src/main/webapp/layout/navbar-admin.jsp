...
%>
       ...
       <div class="navbar-header">
         <button type="button" title="menu hambuguer" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
       ...
       <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
         <ul class="nav navbar-nav">
           <li><a href="<%= request.getContextPath() %>/"> <fmt:message key="jsp.layout.navbar-default.home"/><span class="none">Menu</span></a></li>
