                                        ...
                                        <div class="info">
                                            <div class="kind">
                                                ...
                                                <%
                                                    ...
                                                    {
                                                %>
                                                <div style="display: flex; justify-content: center; align-items: center; padding: 6px 2px; border-radius: 50%; background-color: #FFD100;">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
